...
public class BreakAdapter extends RecyclerView.Adapter<BreakAdapter.ViewHolder> {
    ArrayList<BreakModel> arrayList;
    Context context;

    public BreakAdapter(ArrayList<BreakModel> arrayList, Context context) {
    ...
    @NonNull
    @Override
    public BreakAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_item_product, parent, false);
        return new BreakAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BreakAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v ->  {
            ...
            intent.putExtra("objects6", arrayList.get(position));
