...
public class DrinkAdapter extends RecyclerView.Adapter<DrinkAdapter.ViewHolder> {
    ...
    public DrinkAdapter(ArrayList<DrinkModel> arrayList, Context context) {
    ...
    public DrinkAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new DrinkAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_hoder_popular_list, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull DrinkAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v ->  {
            ...
            intent.putExtra("objects3", arrayList.get(position));
