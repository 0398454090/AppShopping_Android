...
public class ClothesAdapter extends RecyclerView.Adapter<ClothesAdapter.ViewHolder> {
    ArrayList<ClothesModel> arrayList;
    Context context;

    public ClothesAdapter(ArrayList<ClothesModel> arrayList, Context context) {
    ...
    public ClothesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ClothesAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.clothes, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull ClothesAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v ->  {
            ...
            intent.putExtra("objects4", arrayList.get(position));
